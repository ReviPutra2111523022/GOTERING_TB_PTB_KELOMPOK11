...
class TambahMenuActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val EXTRA_PRODUCT_STOCK = "productStock"
    ...
    private lateinit var tvValueStock: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var productStock: Long = intent.getLongExtra(EXTRA_PRODUCT_STOCK, -1L)
        ...
        tvValueStock = findViewById(R.id.tvValueStock)
        ...
        tvValueStock.text = productStock.toString()
        ...
        tomboltambah.setOnClickListener {
            ...
            db.collection("gotering").document(productId).set(
                hashMapOf(
                    "disprice" to productDisprice,
                    "img" to productImageUrl,
                    "name" to productName,

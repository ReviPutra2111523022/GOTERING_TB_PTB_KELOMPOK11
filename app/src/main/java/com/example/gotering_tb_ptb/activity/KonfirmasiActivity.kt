...
class KonfirmasiActivity : AppCompatActivity(){
    ...
    companion object {
        ...
        const val EXTRA_ORDER_STATUS = "orderStatus"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val orderStatus: Int = intent.getIntExtra(EXTRA_ORDER_STATUS, 0)
        ...
        for (product in productsList) {
            ...
            confirm_button.setOnClickListener {
                ...
                for (product in productsList) {
                    ...
                    orderObject.put("status", orderStatus)
                    ordersArray.put(orderObject)
                }
                val bookmarkedOrder = Order(orderID, orderName, orderDate, ordersArray.toString(), orderStatus)
